...
<div class="container">
    ...
    <main>
        <?php
    $cardData = array(
        array("Abrir Chamado", "../../assets/images/menu/abrirChamado.png"),
        array("Lista de Chamados", "../../assets/images/menu/lista_chamados.png"),
        array("Adicionar Funicionários", "../../assets/images/menu/adicionar_funcionarios.png")
    );
